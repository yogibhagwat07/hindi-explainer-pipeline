...
1. **Ledger अनिवार्य।** हर बाहरी clip `fetchclips.py` के `ledger.json`
   में होनी चाहिए — license, license_class, creator, source URL, sha1 के
   साथ। बिना ledger entry वाली clip video में गई तो video reject।
2. **License classes का नियम:**
   - `NC` या `ND` — **कभी नहीं।** Monetised channel पर non-commercial
...
3. **Transformation minimums (यह हमारी policy है, YouTube का लिखा
   नियम नहीं — §6 वाली ग़लती दोबारा नहीं):**
   - Stock clip हमेशा narration के नीचे चलेगी — stock अपने-आप में
     content कभी नहीं।
...
4. **Source की सफ़ाई:**
   - जिस clip पर किसी और का watermark/logo है — मत लो।
...
5. **Music पर यही classes लागू** — जब भी music आए, वही
   PD/FREE/BY/NC-ND जाँच, वही credits नियम।

## Part B में जोड़ो — B-DISCLOSURE: synthetic content का बटन
